...
var urlvalidator_1 = __importDefault(
...
routes1.get('/', urlvalidator_1.default.urlvalidator, function (req, res) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          output_filename =
            output_filename + '-' + width + '-' + height + '-.jpg';
          _a.label = 1;
        case 1:
          _a.trys.push([1, 4, , 9]);
          return [
